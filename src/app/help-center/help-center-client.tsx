...
import { Search, MessageCircle, Mail, Phone, Book, Users, CreditCard, Settings, Calendar } from 'lucide-react';
...
export default function HelpCenterClientPage() {
  ...
  return (
    <div className="min-h-screen bg-muted/40">
      <PageHero
        title="Help Center"
        description="Find answers to your questions and get the help you need. Search our knowledge base or browse guides."
        height="xl"
      />
