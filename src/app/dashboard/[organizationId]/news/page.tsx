...
const newsCategories = ["Event Spotlights", "Platform Updates", "Community Stories"];
...
function NewsArticleForm({ article, onFinished }: { article?: NewsArticle, onFinished: () => void }) {
  const { addNewsArticle, updateNewsArticle, organizations } = useAppContext();
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl><Input {...field} /></FormControl>
              <FormDescription>Link to the full article on your blog or another site.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
...
export default function OrgNewsPage() {
  ...
  const organizationNews = useMemo(() => 
    news.filter(article => article.organizationId === organizationId),
    [news, organizationId]
  );
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Share news and updates from your organization.</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {organizationNews.length} articles published by your organization.
          </CardDescription>
        </CardHeader>
        <CardContent>
